                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active english-data" id="english-data">
                                <div>
                                    ...
                                    <button class="btn btn-light"><img src="{{ asset('images/instagram.png') }}"  width="15px" height="15px"> Instagram</button> 
                                    <button class="btn btn-light"><img src="{{ asset('images/twitter.png') }}"> Twitter</button> 
